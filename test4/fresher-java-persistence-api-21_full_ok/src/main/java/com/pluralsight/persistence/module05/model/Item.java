...
@Entity
//@Inheritance(strategy = InheritanceType.SINGLE_TABLE) //generate table
//@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS) //generate table
@Inheritance(strategy = InheritanceType.JOINED) //generate table
