...
insert into manufacturer (id, name, location_id, average_Yearly_Sales, founded_Date, active) values (1, 'Fender Musical Instruments Corporation', 3, 25000000, '1946-01-01', true);
insert into manufacturer (id, name, location_id, average_Yearly_Sales, founded_Date, active) values (2, 'Gibson Guitar Corporation', 42, 32000000, '1902-01-01', false);
...
insert into model_type (id, name) values (8, null);

insert into model (id, name, manufacturer_id, modeltype_id, price, wood_type, year_first_made, frets) values (1, 'American Stratocaster', 1, 4, 1000, 'Maple, Alder, Ash, Popular', '1954-01-01', 21);
insert into model (id, name, manufacturer_id, modeltype_id, price, wood_type, year_first_made, frets) values (2, 'American Telecaster', 1, 4, 800, 'Maple, Alder, Ash, Pine', '1950-01-01', 22);
insert into model (id, name, manufacturer_id, modeltype_id, price, wood_type, year_first_made, frets) values (3, 'King', 1, 1, 600, 'Variety of high quality woods', '1963-01-01', 19);
insert into model (id, name, manufacturer_id, modeltype_id, price, wood_type, year_first_made, frets) values (4, 'Precision Bass', 1, 7, 900, 'Alder and Ash', '1951-01-01', 21);

insert into model (id, name, manufacturer_id, modeltype_id, price, wood_type, year_first_made, frets) values (5, 'Les Paul', 2, 4, 1600, 'Mahogany and Maple', '1952-01-01', 22);
insert into model (id, name, manufacturer_id, modeltype_id, price, wood_type, year_first_made, frets) values (6, 'SG', 2, 4, 1200, 'Mahogany, Birch and Maple', '1961-01-01', 22);
insert into model (id, name, manufacturer_id, modeltype_id, price, wood_type, year_first_made, frets) values (7, 'ES-335', 2, 6, 2200, 'Maple and Rosewood', '1958-01-01', 22);
insert into model (id, name, manufacturer_id, modeltype_id, price, wood_type, year_first_made, frets) values (8, 'Hummingbird', 2, 1, 900, 'Spruce and Mahogany', '1960-01-01', 20);
insert into model (id, name, manufacturer_id, modeltype_id, price, wood_type, year_first_made, frets) values (9, 'Thunderbird', 2, 7, 1500, 'Mahogany', '1963-01-01', 22);
